/*
From: https://wiki.unrealengine.com/index.php?title=Logs,_Printing_Class_Name,_Function_Name,_Line_Number_of_your_Calling_Code!
	Joy String
...
#define V_LOGF(LogCat, Param1,Param2) 	UE_LOG(LogCat,Error,TEXT("%s: %s %f"), *JOYSTR_CUR_CLASS_LINE, *FString(Param1),Param2)

#define V_LOGM(LogCat, FormatString , ...) UE_LOG(LogCat,Error,TEXT("%s: %s"), 	*JOYSTR_CUR_CLASS_LINE, *FString::Printf(TEXT(FormatString), ##__VA_ARGS__ ) )